...
public class WritingObjects {
    public static void main(String[] args) throws Exception {
		...
		/*
		 * Person shravan = new Person("Shravan",25); Person malavika = new
		 * Person("Malavika",24); entityManager.persist(shravan);
		 * entityManager.persist(malavika);
		 * 
		 * System.out.println(shravan); System.out.println(malavika);
		 */
